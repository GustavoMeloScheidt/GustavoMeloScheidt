...
Driven by a passion for **Artificial Intelligence** and its applications in **healthcare**.
...
- **Research Projects:**  
  ...
  - **Research Internship at [ARTEMIS Laboratory](https://artemis.telecom-sudparis.eu/en/):**  
    2-month research internship focused on **Artificial Intelligence** and **medical imaging segmentation**, specializing in **Mamba architectures** evaluation, optimization, and application to brain MRI scans.
  - Many more projects, specially in the Institut Polytechnique's repo.
